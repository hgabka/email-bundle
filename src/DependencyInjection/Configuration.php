        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('default_sender')
                    ...
                    ->canBeUnset()
                    ->children()
                        ->scalarNode('email')->cannotBeEmpty()->defaultValue('info@example.com')->end()
                        ->scalarNode('name')->cannotBeEmpty()->defaultValue('Acme Company')->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('default_recipient')
                    ...
                    ->canBeUnset()
                    ->children()
                        ->scalarNode('email')->cannotBeEmpty()->defaultValue('info@acme.com')->end()
                        ->scalarNode('name')->cannotBeEmpty()->defaultValue('Acme Subcompany')->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('template_var_chars')
                      ...
                      ->end()
                      ->children()
                          ->scalarNode('prefix')->defaultValue('%%')->cannotBeEmpty()->end()
                          ->scalarNode('postfix')->defaultValue('%%')->cannotBeEmpty()->end()
                      ->end()
                ->end()
